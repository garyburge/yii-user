...
return array(
  ...
  'Reset Password' => 'Reset Password',
	...
	'Your {site_name} Registration' => 'Ви зареєструвалися на сайті {site_name}',
	'Before logging in, you must first activate your account by clicking this link: {activation_url}.' => 'Для активації профіля, будь ласка, перейдіть за цим посиланням {activation_url}',
	...
	'Thank you for your registration. Please check your email before logging in.' => 'Реєстрацію завершено. Будь ласка, перевірте свою електронну пошту або увійдіть на сайт',
