...
return array(
  ...
  'Reset Password' => 'Reset Password',
	...
	'Your {site_name} Registration' => 'Εχετε εγγραφεί στο {site_name}',
	'Before logging in, you must first activate your account by clicking this link: {activation_url}.' => 'Παρακαλούμε ενεργοποιήστε το λογαριασμό σας κάνοντας κλικ σ\'αυτόν τον σύνδεσμο: {activation_url}',
	...
	'Thank you for your registration. Please check your email before logging in.' => 'Ευχαριστούμε για την εγγραφή σας.Παρακαλούμε δείτε το ηλεκτρονικό σας ταχυδρομείο ή συνδεθείτε.',
