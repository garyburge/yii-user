...
return array(
  ...
  'Reset Password' => 'Reset Password',
	...
	'Your {site_name} Registration' => 'あなたは {site_name} にユーザー登録されました。',
	'Before logging in, you must first activate your account by clicking this link: {activation_url}.' => 'あなたのアカウントを有効にするために、アカウント認証 URL {activation_url} にアクセスして下さい。',
	...
	'Thank you for your registration. Please check your email before logging in.' => 'ユーザー登録ありがとうございます。メールを確認するか、ログインして下さい。',
