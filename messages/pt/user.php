...
return array(
  ...
  'Reset Password' => 'Reset Password',
	...
	'Your {site_name} Registration' => 'Você se cadastrou no site {site_name}',
	'Before logging in, you must first activate your account by clicking this link: {activation_url}.' => 'Por favor, ative a sua conta indo na seguinte url:<br/> <a href="{activation_url}">{activation_url}</a>',
    ...
    'Thank you for your registration. Please check your email before logging in.' => "Obrigado por cadastrar-se. Dentro de poucos minutos você receberá um email com as instruções para ativação de seu login.",
