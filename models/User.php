...
class User extends CActiveRecord
{
    ...
    public function rules()
    {
      ...
      return ((get_class(Yii::app()) == 'CConsoleApplication' || (get_class(Yii::app()) != 'CConsoleApplication' && Yii::app()->getModule('user')->isAdmin())) ? array(
        array('username', 'length', 'max'=>20, 'min'=>8, 'message'=>UserModule::t("Incorrect username (length between 8 and 20 characters).")),
        array('password', 'length', 'max'=>128, 'min'=>8, 'message'=>UserModule::t("Incorrect password (minimum length is 8 character).")),
        array('email', 'email'),
